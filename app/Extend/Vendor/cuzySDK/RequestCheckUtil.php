...
class RequestCheckUtil
{
	...
	public static function checkValueWithIn($value,$range,$fieldName){
		if(self::checkEmpty($value))
			return ;
		if(!in_array($value,$range)){
			throw new Exception("client-check-error:Invalid Arguments:the value of " . $fieldName . " can not in allow range  ." , 41);
		}
	}
}
?>